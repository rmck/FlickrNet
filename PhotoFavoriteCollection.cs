// Type: FlickrNet.PhotoFavoriteCollection
...
namespace FlickrNet
{
  public sealed class PhotoFavoriteCollection : Collection<PhotoFavorite>, IFlickrParsable
  {
    ...
    void IFlickrParsable.Load(XmlReader reader)
    {
      ...
      while (reader.LocalName == "person")
      {
        ...
        photoFavorite.Load(reader);
        this.Add(photoFavorite);
      }
      reader.Skip();
    }
  }
