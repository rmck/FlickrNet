// Type: FlickrNet.GroupSearchResultCollection
...
namespace FlickrNet
{
  public sealed class GroupSearchResultCollection : Collection<GroupSearchResult>, IFlickrParsable
  {
    ...
    void IFlickrParsable.Load(XmlReader reader)
    {
      ...
      while (reader.LocalName == "group")
      {
        ...
        groupSearchResult.Load(reader);
        this.Add(groupSearchResult);
      }
      reader.Skip();
    }
  }
