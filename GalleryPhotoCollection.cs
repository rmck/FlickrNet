// Type: FlickrNet.GalleryPhotoCollection
...
namespace FlickrNet
{
  public sealed class GalleryPhotoCollection : Collection<GalleryPhoto>, IFlickrParsable
  {
    ...
    void IFlickrParsable.Load(XmlReader reader)
    {
      ...
      while (reader.LocalName == "photo")
      {
        ...
        galleryPhoto.Load(reader);
        this.Add(galleryPhoto);
      }
      reader.Skip();
    }
  }
