...
namespace FlickrNet
{
  public class Photo : IFlickrParsable
  {
    ...
    public string LargeSquareThumbnailUrl
    {
      get
      {
        if (this.urlLargeSquare != null)
          return this.urlLargeSquare;
        else
    ...
    public string Small320Url
    {
      get
      {
        if (this.urlSmall320 != null)
          return this.urlSmall320;
        else
    ...
    public string Medium640Url
    {
      get
      {
        if (this.urlMedium640 != null)
          return this.urlMedium640;
        else
    ...
    public string Medium800Url
    {
      get
      {
        if (this.urlMedium800 != null)
          return this.urlMedium800;
        else
          return UtilityMethods.UrlFormat(this, "_z", "jpg");
      }
    }
    ...
    public string OriginalUrl
    {
      get
      {
        ...
        if (this.OriginalFormat == null || this.OriginalFormat.Length == 0)
          return (string) null;
        else
    ...
    public bool DoesLargeExist
    {
      get
      {
        return this.urlLarge != null || this.OriginalHeight > 1280 || this.OriginalWidth > 1280;
      }
    }
    ...
    public bool DoesMediumExist
    {
      get
      {
        return this.urlMedium != null || this.OriginalHeight > 500 || this.OriginalWidth > 500;
      }
    }
